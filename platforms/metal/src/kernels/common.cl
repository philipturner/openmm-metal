...
// TODO: Trim the declaration of subgroup_extended_types, use a pre-compiled
// header (https://github.com/emrainey/OpenCL-Environment), in order to reduce
// compile time. Measure the difference in startup overhead with and without the
// Metal header.
#ifdef VENDOR_APPLE
