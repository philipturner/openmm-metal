...
class OPENMM_EXPORT_COMMON MetalCompact {
public:
    MetalCompact(MetalContext& context);
    void compactStream(MetalArray& dOut, MetalArray& dIn, MetalArray& dValid, MetalArray& numValid);
private:
    MetalContext& context;
    MetalArray dgBlockCounts;
