...
public:
    ...
    // Duplicated function definition due to OpenMM release lagging behind the
    // main branch.
...
private:
    ...
    double lastCutoff;
    bool useCutoff, usePeriodic, deviceIsCpu, anyExclusions, usePadding, useNeighborList, forceRebuildNeighborList, useLargeBlocks, useGhostAtoms;
