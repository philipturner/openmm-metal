...
public:
    ...
    /**
     * This is the name of the parameter for selecting which Metal device or devices to use.
     */
    ...
    /**
     * This is the name of the parameter that reports the Metal device or devices being used.
     */
    ...
    /**
     * This is the name of the parameter for selecting which Metal platform to use.
     */
    static const std::string& MetalPlatformIndex() {
        static const std::string key = "MetalPlatformIndex";
        return key;
    }
    /**
     * This is the name of the parameter that reports the Metal platform being used.
     */
    static const std::string& MetalPlatformName() {
        static const std::string key = "MetalPlatformName";
        return key;
    }
    /**
