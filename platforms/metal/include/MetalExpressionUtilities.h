...
class OPENMM_EXPORT_COMMON MetalExpressionUtilities : public ExpressionUtilities {
public:
    MetalExpressionUtilities(ComputeContext& context) : ExpressionUtilities(context) {
    }
};
